    ...
    return (
        <div className="contact-container">
            <div className="contact-form-wrapper">
                <h1 className="contact-form-title">Reservas</h1>
                <div className="contact-form-container">
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="contact-form-field">
                            <label className="contact-form-label" htmlFor="date">Día de reserva:</label>
                            <input
                                type="date"
                        ...
                        <div className="contact-form-field">
                            <label className="contact-form-label" htmlFor="time">Hora de reserva:</label>
                            <input
                                type="time"
